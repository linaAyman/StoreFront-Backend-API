...
var getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.getUserById(Number(req.params.id))];
            case 1:
                fetchedUser = _a.sent();
...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createdUser, token, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.createUser(req.body)];
            case 1:
                createdUser = _a.sent();
                token = jsonwebtoken_1.default.sign(createdUser, config_1.default.jwtKey);
...
var deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userModel.deleteUser(Number(req.params.id))];
            case 1:
                deletedUser = _a.sent();
