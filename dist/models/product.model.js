        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Failed to retreive products data due to this error: ".concat(error_1)); //to avoid returning undefined
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Failed to retreive this product data due to this error: ".concat(error_2)); //to avoid returning undefined
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(query, [product.name, product.price])];
                    case 2:
                        res = _a.sent();
                        //end the connection and return rows
                        conn.release();
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Failed to create a new product due to this error: ".concat(error_3)); //to avoid returning undefined
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Failed to update product data due to this error: ".concat(error_4)); //to avoid returning undefined
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Failed to delete this product due to this error: ".concat(error_5)); //to avoid returning undefined
                    case 4: return [2 /*return*/];
                }
            });
        });
